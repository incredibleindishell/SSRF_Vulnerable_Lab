...
if(isset($_POST['load']))
{
   ...
   <tr><td align=center style="padding: 10px;" >
	<form method=post action="'.$_SERVER['SCRIPT_NAME'].'">Specify the file name to download: <input type=text name=file value=local.txt><br><br><input type=submit name=download value="Donwload file"></form>
